...
Authors: J. Fan, X. Ye, J. Kim, B. Archambeault and A. Orlandi, "Signal Integrity Design for High Speed Digital Circuits: Progress and Directions," in IEEE Transactions on Electromagnetic Compatibility, vol. 52, no. 2, pp. 392-400, May 2010, doi: 10.1109/TEMC.2010.2045381.
...
Authors: T. -L. Wu, F. Buesink and F. Canavero, "Overview of Signal Integrity and EMC Design Technologies on PCB: Fundamentals and Latest Progress," in IEEE Transactions on Electromagnetic Compatibility, vol. 55, no. 4, pp. 624-638, Aug. 2013, doi: 10.1109/TEMC.2013.2257796.
...
Authors: F. Garbuglia, T. Reuschel, C. Schuster, D. Deschrijver, T. Dhaene and D. Spina, "Modeling Electrically Long Interconnects Using Physics-Informed Delayed Gaussian Processes," in IEEE Transactions on Electromagnetic Compatibility, vol. 65, no. 6, pp. 1715-1723, Dec. 2023, doi: 10.1109/TEMC.2023.3317917.
...
Keywords: [Training;Performance evaluation;Adaptation models;Accuracy;Neural networks;Machine learning;Predictive models;neural networks;machine learning;signal and power integrity;high-speed channels;channel modeling]

## 7.SI/PI-Database of PCB-Based Interconnects for Machine Learning Applications (Possible Dataset)
URL: https://ieeexplore.ieee.org/document/9361755

Authors: M. Schierholz _et al_., "SI/PI-Database of PCB-Based Interconnects for Machine Learning Applications," in _IEEE Access_, vol. 9, pp. 34423-34432, 2021, doi: 10.1109/ACCESS.2021.3061788.

Keywords: [Tools;Databases;Electromagnetic compatibility;Integrated circuit interconnections;Machine learning;Electromagnetics;Simulation;Artificial neural network;database;electromagnetic compatibility;machine learning;power integrity;signal integrity]
